...
import com.ali.coffeehub.config.Constants;
import com.ali.coffeehub.domain.UserEntity;
import com.ali.coffeehub.repository.AuthorityRepository;
...
import com.ali.coffeehub.service.dto.PasswordChangeDTO;
import com.ali.coffeehub.web.rest.vm.KeyAndPasswordVM;
import com.ali.coffeehub.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        UserEntity updatedUser = userRepository.findOneByLogin("save-existing-email").orElseThrow();
