...
public class ToolEntity implements Serializable {
    ...
    public ToolEntity brewId(Long brewId) {
    ...
    public ToolEntity createdAt(Instant createdAt) {
    ...
    public ToolEntity createdBy(String createdBy) {
    ...
    public ToolEntity updatedAt(Instant updatedAt) {
    ...
    public ToolEntity updatedBy(String updatedBy) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((ToolEntity) o).getId());
    }
